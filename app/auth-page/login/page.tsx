        ...
        <div className="hidden md:flex relative w-1/2 flex-col justify-between p-8 m-3 rounded-3xl overflow-hidden bg-gradient-to-br from-[#14123B] via-[#1D1B4B] to-[#2A2678]">
          ...
          <div className="relative z-10 text-white">
            ...
            <h2 className="text-2xl font-bold leading-snug">
              Access your Discord community dashboard
            </h2>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 mt-1 rounded-xl text-sm font-semibold cursor-pointer bg-violet-600 hover:bg-violet-700 text-white shadow-lg shadow-violet-600/30 transition-all"
              >
                {isLoading ? (
                  <>
